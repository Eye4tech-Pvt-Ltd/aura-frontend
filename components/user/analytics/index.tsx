            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-semibold text-accent-green-600">
                    96.8%
                  </span>
                </div>
                <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-accent-green-400 to-accent-green-600 rounded-full"
                    style={{ width: '96.8%' }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-accent-purple-400 to-accent-purple-600 rounded-full"
                    style={{ width: '92.3%' }}
                  ></div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-6 border border-primary-200 shadow-md">
            ...
            <div className="space-y-3 mt-4">
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-slate-700">
                  45% of calls result in bookings
                </p>
              </div>
              <div className="flex items-start gap-2">
