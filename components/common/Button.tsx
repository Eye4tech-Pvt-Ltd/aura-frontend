...
export default function Button({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-slate-100 text-slate-700 hover:bg-slate-200 border border-slate-200 hover:border-slate-300',
    ghost: 'text-slate-700 hover:bg-slate-100',
    danger: 'bg-gradient-to-r from-accent-red-500 to-accent-red-600 text-white hover:from-accent-red-600 hover:to-accent-red-700 shadow-md hover:shadow-lg active:scale-95'
  }[variant];
