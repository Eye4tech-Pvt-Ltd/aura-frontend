import { Sparkles, Volume2, Settings, Brain, MessageSquare, Zap, Shield, Play } from 'lucide-react';
...
const voiceOptions = [
  { id: 'sophia', name: 'Sophia', accent: 'American', gender: 'Female', active: true },
  { id: 'james', name: 'James', accent: 'British', gender: 'Male', active: false },
  { id: 'aria', name: 'Aria', accent: 'Australian', gender: 'Female', active: false },
  { id: 'marcus', name: 'Marcus', accent: 'American', gender: 'Male', active: false },
];

const businessRules = [
  { id: 1, title: 'Always confirm appointment details', description: 'Repeat date, time, and service before booking', active: true },
  { id: 2, title: 'Collect customer preferences', description: 'Ask about preferred contact method and time', active: true },
  { id: 3, title: 'Handle objections gracefully', description: 'Use empathy and offer alternatives', active: true },
  { id: 4, title: 'Transfer complex queries', description: 'Escalate to human agent when needed', active: true },
];
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-slate-600">Customize your AI agent&apos;s personality and behavior</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200/60 shadow-md">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-lg font-semibold text-slate-900">Tone & Personality</h2>
            </div>
              ...
              {toneAttributes.map((attr) => (
                <div key={attr.label}>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-semibold text-primary-600">{attr.value}%</span>
                  </div>
            ...
            <div className="mt-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
              <p className="text-sm text-slate-600 mb-2 font-medium">Custom Instructions</p>
              <textarea
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200/60 shadow-md">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-lg font-semibold text-slate-900">Voice Selection</h2>
            </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-slate-600">{voice.accent} • {voice.gender}</p>
                    </div>
